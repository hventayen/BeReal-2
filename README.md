...
**BeReal 2** is an app that introduces storing data into the cloud server in the BeReal application.
...
Describe any challenges encountered while building the app. The implementing of the back end of it was difficult.
